module.exports = {
  ...
  storageClassesType: 'Storage Class',
  ...
  'restore.msg.no':
    'The selected files to restore include IA files, Standard files, files that are being restored, or restored files. You do not need to restore these files.',
  restore: 'Restore',
  ...
  'file.md.name.error.2dots': 'The subfolder name cannot contain consecutive periods (.)',
  'file.md.name.error.continuous slash': 'The name cannot contain consecutive forward slashes (/).',
  ...
  'restore.days.tips.365': 'Validity range 1-365 days',
  'restore.file.type.archive': 'Archive Object',
  'restore.file.type.cold.archive': 'Cold Archive Object',
  'restore.file.type.deep.cold.archive': 'Deep Cold Archive Object',
  'restore.copyvalidity': 'Replica Validity Period',
  'restore.mode': 'Restore Mode',
  'restore.mode.type.expedited': 'Expedited',
  'restore.mode.type.standard': 'Standard',
  'restore.mode.type.bulk': 'Bulk',
  'restore.mode.type.expedited.explain': 'Restored within 1 hour.',
  'restore.mode.type.standard.explain': 'Restored within 2 to 5 hours.',
  'restore.mode.type.bulk.explain': 'Restored within 5 to 12 hours.}',
  'restore.mode.type.expedited.explain.deep': 'The object is restored within 12 hours and can be read after the object is restored.',
  'restore.mode.type.standard.explain.deep': 'The object is restored within 48 hours and can be read after the object is restored.',
  restoring: 'restoring',
