module.exports = {
  ...
  'search.files.num_msg': '当前已加载的目录及Object数量为{{num}}，并非当前Bucket的总共Object数量。',
  ...
  'restore.title': '解冻',
  'restore.msg': '请选择需要解冻的文件',
  'restore.msg.no':
    '勾选的解冻文件列表中包含低频访问/标准存储/解冻中/已解冻的文件，这些文件无需进行解冻操作。',
  restore: '解冻',
  restoring: '解冻中',
  ...
  'file.md.name.error.emoji': '目录路径中不允许出现表情符，请使用符合要求的 UTF-8 字符',
  ...
  'restore.days.tips.365': '有效期范围1～365天',
  'restore.file.type.archive': '归档存储文件',
  'restore.file.type.cold.archive': '冷归档存储文件',
  'restore.file.type.deep.cold.archive': '深度冷归档存储文件',
  'restore.copyvalidity': '副本有效期',
  'restore.mode': '恢复模式',
  'restore.mode.type.expedited': '高优先级',
  'restore.mode.type.standard': '标准',
  'restore.mode.type.bulk': '批量',
  'restore.mode.type.expedited.explain': '1小时内完成解冻',
  'restore.mode.type.standard.explain': '2～5小时内完成解冻',
  'restore.mode.type.bulk.explain': '5～12小时内完成解冻',
  'restore.mode.type.expedited.explain.deep': '12小时内完成解冻，解冻完成后才能读取',
  'restore.mode.type.standard.explain.deep': '48小时内完成解冻，解冻完成后才能读取',
};
