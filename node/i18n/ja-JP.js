module.exports = {
  ...
  'storageClassesType.deepcoldarchive': 'ディープコールドアーカイブストレージ',
  ...
  'restore.msg.no':
    'チェックされている解凍ファイルのリストには、解凍操作を必要としない低周波アクセス/標準保存/解凍中/解凍済みファイルが含まれています。',
  restore: 'リストア',
  ...
  'file.md.name.error.2dots': 'サブフォルダー名には、連続したピリオド (.) を含むことはできません。',
  ...
  'restore.days.tips.365': '有効期限 1～365日',
  'restore.file.type.archive': 'アーカイブストレージファイル',
  'restore.file.type.cold.archive': 'コールドアーカイブストレージファイル',
  'restore.file.type.deep.cold.archive': 'ディープコールドアーカイブストレージファイル',
  'restore.copyvalidity': 'レプリカ有効期間',
  'restore.mode': 'リカバリモード',
  'restore.mode.type.expedited': '高い優先度',
  'restore.mode.type.standard': '標準',
  'restore.mode.type.bulk': 'バッチ',
  'restore.mode.type.expedited.explain': '1時間以内に解凍を完了します',
  'restore.mode.type.standard.explain': '2～5時間以内に解凍を完了します',
  'restore.mode.type.bulk.explain': '5～12時間以内に解凍を完了します',
  'restore.mode.type.expedited.explain.deep':
    '12時間以内に解凍を完了し、解凍が完了してから読み込むことができます',
  'restore.mode.type.standard.explain.deep':
    '48時間以内に解凍を完了し、解凍が完了してから読み取ることができます',
  restoring: '解凍中',
