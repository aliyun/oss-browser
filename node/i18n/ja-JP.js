module.exports = {
  ...
  "region.oss-ap-northeast-1": "日本 (東京)",
  "region.oss-ap-northeast-2": "韓国 (ソウル)",
  "region.oss-ap-south-1": "アジア南部 1 (ムンバイ)",
  "region.oss-ap-southeast-6": "フィリピン（マニラ）",
  "region.oss-ap-southeast-7": "タイ（バンコク）",

  "region.oss-us-west-1": "シリコンバレー (米国西部 1)",
  "region.oss-us-east-1": "バージニア (米国東部 1)",
  "region.oss-eu-central-1": "フランクフルト (ドイツ)",
  "region.oss-me-east-1": "アラブ首長国連邦（ドバイ）",
