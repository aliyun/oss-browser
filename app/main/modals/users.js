...
angular.module('web')
  .controller('usersCtrl', ['$scope','$rootScope','$q', '$translate','$state','$uibModalInstance','$uibModal','ramSvs','Dialog','Toast',
  function($scope,$rootScope,$q, $translate, $state,$modalInstance, $modal,ramSvs, Dialog, Toast){
